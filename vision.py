...
class Vision:
    ...
    #         return np.array([], dtype=np.int32).reshape(0, 4)  # Return an empty array

    #     print('found locations:', locations)
    #     rectangles = [(*loc, self.needle_w, self.needle_h) for loc in locations] * 2
    #     rectangles, weights = cv.groupRectangles(rectangles, groupThreshold=1, eps=0.5)

    #     print('grouped rectangles:', rectangles)
    ...
    def find(self, haystack_img, threshold=0.5, max_results=20):
        ...
        #save imshow to file
        fileName_with_timestamp = "./Detections/detection_"+str(time())+".jpg"
